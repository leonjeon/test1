...
//dto(Date Transter Object) 데이터를 전송,이동 하는 객체다. == vo(Value Object) == do(domain Object) == entify == bean
...
//4. toString(), equals() 등에 오버라이딩해야 함 (선택사항임)
//5. 반드시 질렬화할 것 : 네트워크 입출력을 위해 객체 인스턴스를 1바이트 크기로 일렬로 나열하는 것
...
public class Person implements java.io.Serializable {
	...
	public Person() {
		...
		this("noname", 0, ' ', "nomail", "000-00000-00000");  //같은 클래스의 다른 생성자 실행 구문임
		//생성자 안에서 첫줄에만 작성함
	}
	...
	//규칙 3. 부모다 가진 예외를 갯수를 줄일 수 있음 : 0개까지 가능
	@Override
	public Object clone() {
