...
//			int num2 = 33;
		...
		public void 부호연산자테스트() {
			int num = -25;
			System.out.println("num1:" +  +num); //+1 * -25 => -25
			System.out.println("num2:" +  -num);	//-1 * -25 => 25 			
		}
		...
		public void 증감연산자테스트() {
			...
			int result = num++; //처리 후 증가를 의미함
			//result = num;   num++;
			System.out.println("result : " + result); //10
			System.out.println("num : " + num);	//11
			
			int result2 = ++result;  //선증가 후 처리를 의미함
		...
		public void  형변환연산자테스트() {
			...
			int result = b1 + s1; //byte와 short의 연산 결과형은 무조건 int 다.
		...
		public void 비교연산자테스트() {
			...
			System.out.println("second<= 200 : " + (second <= 200));  //200이하냐(< or ==): true
			System.out.println("first == 100 : " + (first == 100));  //100이냐 : true
			System.out.println("first != 100 : " + (first != 100));  //100이 아니냐false			
		}
		...
		public void 일반논리연산자연습() {
			//&& : 제시한 모든 조건이 다맞는지(true) 확인할 때
			//값의 범위를 확인하는 용도로 많이 쓰임
			
			//예 : 키보드로 정수를 하나 입력받아,
			//입력된 정수가 1부터 100사이의값인지 확인 출력
			//1 <= 정수 <= 100
			//Scanner sc = new Scanner(System.in);
			
			System.out.print("정수 입력");
			//int num = sc.nextInt();
			int num = new Scanner(System.in).nextInt(); //한번만 사용할 때 간략하게 사용
			
			System.out.println(num + " 1 >= 정수 <= 100 : " + (num >= 1 && num <= 100));
			
		}
		
		public void isPositiveNumber() {
			//키보드로 정수를 하나 입력받아, 양수인지 확인하는 출력 구문 작성			
		...
		public void isUppercase() {
			...
			char Text = new Scanner(System.in).next().charAt(0);
			
			//System.out.println('A' <= Text <= 'Z' + (Text >='A' || Text <='Z'));
			System.out.println(Text >= 'A' && Text <= 'Z'); 
			System.out.println(Text >= 65 && Text <= 91);	
		}
		
		public void isYes() {
			//연습3 :
			//문자 하나를 입력 받아, 'Y' 또는 'y' 이냐에 대한 결과 출력
			
			System.out.println("문자 하나 입력");
			char Text1 = new Scanner(System.in).next().charAt(0);						
		
			System.out.println("yes or No? "+ (Text1 == 'Y' ||Text1 == 'y'));
		}
		...
		public void 일반논리연산자특징확인() {
			...
			System.out.println(false && ++num > 0); // ++num 변수 먼저 계산(11) > 0 false
		...
		public void 삼항연산자테스트() {
			//첫번째 ? 두번째 : 세번째
			//첫번째는 조건식을 사용함 : 반드시 참 또는 거짓의 결과가 나오게 작성해야 함
		...
		public void 삼항연산자중첩사용2() {
			//연습 :
			//문자를 하나 입력받아서
			//영어대문자이면 "upper", 소문자이면 "lower",숫자문자이면 "digit",그 외 문자는 "ete" 출력
		...
		public void printScoreGrade() {
			...
			System.out.println("점수 "+ score +"점은 등급으로 "+ result +" 입니다.");
