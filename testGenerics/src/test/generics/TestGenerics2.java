...
public class TestGenerics2 {
	...
	public static void main(String[] args) {
		// 제네릭스(Generics) 기능 :
		// 사용시 클래스 타입을 정하면서 이용하는 기능이다.
		// 클래스명<영문자> 또는 인터페이스명<영문자> 표시된 클래스들이 제레릭스 기능을 사용할 수 있다는 표시다.
		// 클래스 사용시 한가지 타입의 클래스 객체만 취급하겠다는 용도로 사용함
		List<String> list = listAllocation();	//String 객체만 저장하는 리스트로 선언함
		//String 이 아닌 객체는 저장할 수 없다.
	...
	private static void printList(List<String> list) {
		...
		// Object 타입이 아니라 표기된 제네릭스 타입으로 추출 됨 => 타입확인 필요없음, 다운캐스팅 필요없음
	...
	//해당 메소드의 반환자료형에도 같은 타입의 제네릭스 사용되어야 한다.
