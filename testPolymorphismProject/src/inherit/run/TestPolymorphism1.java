...
public class TestPolymorphism1 {
	...
	public static void main(String[] args) {
		...
		p = new Customer("김철수", 28, '남', "kim@naver.com", "010-1234-5678", 
				"서울시 서초구 신논현동 77", 1350.77);
		System.out.println(p); //p.thString()과 같음
		
		Customer c = new Customer("홍길순", 55, '남', "hong77@gmail.com", "010-9876-5678", 
				"경기도 하남시 미사동 미사리", 99999.99);
		
		p = c;
		System.out.println(p); //p.thString()과 같음
		
		p = new Student("김철수", 28, '남', "kim@naver.com", "010-1234-5678", 
				12, "영어영문학", 3.7);
		System.out.println(p); //p.thString()과 같음
		...
		obj = new Customer("김철수", 28, '남', "kim@naver.com", "010-1234-5678", 
				"서울시 서초구 신논현동 77", 1350.77);
		System.out.println(obj);//obj.toString()
